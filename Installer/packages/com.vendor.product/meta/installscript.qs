...
Component.prototype.createOperations = function()
{
    try {
		...
		if (systemInfo.productType === "windows"){
			component.addOperation("CreateShortcut", "@TargetDir@/BluetoothTerminal.exe", "@StartMenuDir@/Bluetooth Terminal.lnk",
				"workingDirectory=@TargetDir@", "iconPath=%SystemRoot%/system32/SHELL32.dll",
				"iconId=2", "description=Open Bluetooth Terminal");
			component.addOperation("CreateShortcut", "@TargetDir@/maintenancetool.exe", "@StartMenuDir@/Uninstaller.lnk",
				"workingDirectory=@TargetDir@", "iconPath=%SystemRoot%/system32/SHELL32.dll",
				"iconId=2", "description=Uninstall Bluetooth Terminal");
		}
    } catch (e) {
        console.log(e);
    }
